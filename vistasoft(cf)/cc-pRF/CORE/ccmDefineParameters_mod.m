function params = ccmDefineParameters_mod(view, sourceROI, targetROI,surr,win)
...
%% changed code so maximum CF size is 10mm
params.analysis.sigmas = linspace(0.0001,10,50);
...
params.analysis.allstimimages = ccmLoadData_mod(view,params,params.sourceROI);
