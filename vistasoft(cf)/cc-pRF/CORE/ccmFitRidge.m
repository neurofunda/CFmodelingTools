function ridge = ccmFitRidge(view,params)
...
% load the data
[dataSource] = ccmLoadData(view, params, params.sourceROI);
...
%     s{n}=ccmFit_core_ridge(s{n},prediction,data,params,t,dataSource);
% end
% 
